...
import com.example.fallennymous.prekjutelulas.OrderStatus;
...
public class ListenOrder extends Service implements ChildEventListener {
    ...
    private  void showNotification(String key, Request request){
        ...
        builder.setAutoCancel(true)
                ...
                .setTicker("PrekuTelulas")
                .setContentInfo("{esanan sudah di update")
                .setContentText("Pesanan #"+key+"status di perbarui ke"+ Common.convertCodeToStatus(request.getStatus()))
